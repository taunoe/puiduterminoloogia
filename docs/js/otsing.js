    ...
    //$.getJSON( 'json/', phrase +'.json' , function(data){
      //$.getJSON( 'json/', url+'.json' , function(data){
        ...
        if ( data ) {
          ...
          cache[ url ] = {
            title: data.eesti,
            elem: $( '<div class="item"/>' ).html( "<h1>" + data.eesti + "</h1><div id=\"tolked\"><ul ><li>Inglise keeles: " + data.inglise + "</li><li>Saksa keeles: " + data.saksa + "</li><li>Vene keeles: " + data.vene + "</li><li>Soome keeles: " + data.soome + "</li></ul></div><p>" + data.seletuseesti + "</p>" + "<div id=\"kirjeldus\"><p>" + data.kirjeldus +"</div></p>").appendTo( '.content' )
          };
